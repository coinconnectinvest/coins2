...
static CBigNum bnProofOfStakeLimit(~uint256(0) >> 6);
...
unsigned int nStakeTargetSpacing = 0.5 * 60;			// 0.5 minute block spacing
...
static const int64 nTargetSpacingWorkMax = 1 * nStakeTargetSpacing; // 0.5 min
